...
');
?>
<div class="tabs-component" style="padding: 0;">
    <div class="tabs-component__header no-padding">
        <div class="tabs-component__header--left inner">
    ...
    <div class="tabs-component__panels no-padding">
        <slot></slot>
    </div>
</div>